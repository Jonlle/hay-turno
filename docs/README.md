...
Documentation and planning artifacts for HayTurno live here.

## Purpose

- Keep SDD materials visible inside the repository
- Document architecture, scope, and implementation decisions
- Make project context easy to review before code exists
